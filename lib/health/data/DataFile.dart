...
static  String idealLink="https://www.calculator.net/ideal-weight-calculator.html";
static  String bmiLink="https://www.calculator.net/bmi-calculator.html";
static  String bodyFatLink="https://www.calculator.net/body-fat-calculator.html";
static  String caloriesLink="https://www.calculator.net/calorie-calculator.html";
static  String waterIntakeLink="https://www.gigacalculator.com/calculators/water-intake-calculator.php";
static  String targetHeartLink="https://www.calculatorsoup.com/calculators/health/target-heart-rate-zone-calculator.php";
static  String pregnancyLink="https://www.calculator.net/due-date-calculator.html";
static  String ovulationBloodLink="https://www.calculator.net/ovulation-calculator.html";
static  String bloodVolumeLink="https://www.easycalculation.com/medical/blood-volume.php";
static  String bloodDonationLink="https://miniwebtool.com/blood-donation-time-calculator/";
static  String bloodAlcoholLink="https://www.calculator.net/bac-calculator.html";
static  String breathCountLink="https://www.easycalculation.com/health/breath-count.php";
static  String bloodPressureLink="https://www.fortisescorts.in/blood-pressure-calculator";



static List<String> getLinkList(BuildContext context) {
  return [idealLink,bmiLink,bodyFatLink,caloriesLink,waterIntakeLink,targetHeartLink
    ,pregnancyLink,ovulationBloodLink,bloodVolumeLink,bloodDonationLink,bloodAlcoholLink,breathCountLink,bloodPressureLink];
}
  ...
  static List<String> getMainIcon(BuildContext context) {
    return ["Body Fat.svg","Body Mass.svg","Body Fat 2.svg","Calories.svg","Water Intake.svg","Target Heart Rate.svg",
      "Pregnancy.svg","Ovulation.svg","Blood volume.svg","Blood donation.svg","Blood Alcohol.svg",
      "Breath Count.svg","Breath Count.svg"];
  }

  static List<String> getTransparentIcon(BuildContext context) {
    return ["","body_mass_icon.svg","body_fat.svg","calories_icon.svg","water_intake_icon.svg","target_heart_icon.svg",
      "pregnancy_icon.svg","ovulation_period_icon.svg","blood_volume_icon.svg","blood_donation_icon.svg","blood_alcohol_icon.svg",
      "breath_count_icon.svg","breath_count_icon.svg"];
  }

  static List<HomeScreenData> getHomeData(){
  return [
    HomeScreenData("Ideal Weight.svg","Ideal weight",),
    HomeScreenData("Body Mass.svg","Body mass index",),
    HomeScreenData("Body Fat 2.svg","Body fat",),
    HomeScreenData("Calories.svg","Calorias for Weight Gain/Loss",),
    HomeScreenData("Water Intake.svg","Water intake",),
    HomeScreenData("Target Heart Rate.svg","Target heart",),
    HomeScreenData("Pregnancy.svg","Pregnancy duration",),
    HomeScreenData("Ovulation.svg","Ovulation period",),
    HomeScreenData("Blood volume.svg","Blood volume",),
    HomeScreenData("Blood donation.svg","Blood donation",),
    HomeScreenData("Blood Alcohol.svg","Blood alcohol",),
    HomeScreenData("Breath Count.svg","Breath count",),
  ];
  }
...
static List<Color> getColorList() {
  return [ConstantData.idealweightColor,ConstantData.bodymassindexColor,ConstantData.bodyfatColor,ConstantData.caloriasColor,ConstantData.waterintakeColor,ConstantData.targetheartColor,ConstantData.pregnancydurationColor,ConstantData.ovulationperiodColor,ConstantData.bloodvolumeColor,ConstantData.blooddonationColor,ConstantData.bloodalcoholColor,ConstantData.breathcountColor,ConstantData.color13,ConstantData.color14,ConstantData.color15];
}

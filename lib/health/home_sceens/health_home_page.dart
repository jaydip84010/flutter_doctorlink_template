...
class HealthHomePageScreen extends StatefulWidget {
 ...
 final Function? function;
  const HealthHomePageScreen({Key? key,this.function,}) : super(key: key);
        ...
        builder: (homePageScreenController) {
          return WillPopScope(
            ...
            child: Scaffold(
                ...
                appBar: ConstantWidget.getNoneAppbar(color: ConstantData.appbarBgColor),
                drawer: Drawer(
                  backgroundColor: ConstantData.bgColor,
                  child: DrawerWidget(),
                ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            // SizedBox(width: 20.h,)
// ,
                            Expanded(child: getCustomFont("Health calculation", 21.sp,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                margin: EdgeInsets.only(top: 16.h,bottom: 16.h,left: (index == 0)?20.h:8.h,right: (index == blogList.length-1)?20.h:8.h),
                                width: 330.h,
                                decoration: BoxDecoration(
                                  color: ConstantData.ContainerbgColor,
                                    boxShadow: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    getVerSpace(16.h),
                                    getCustomFont(blog.title ?? "", 15.sp, ConstantData.textColor, 1,fontWeight: FontWeight.w600),
                                    getVerSpace(4.h),
